...
func (s *Server) Setup() error {
	...
	s.mux.HandleFunc("GET /api/loras", s.handleListLoras)
	s.mux.HandleFunc("POST /api/loras", s.handleUploadLora)
	s.mux.HandleFunc("DELETE /api/loras/{name}", s.handleDeleteLora)
